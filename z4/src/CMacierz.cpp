...
template Macierz<LZespolona, 3> operator *(LZespolona l, const Macierz<LZespolona, 3> M);
...
template Macierz<LZespolona, 4> operator *(LZespolona l, const Macierz<LZespolona, 4> M);
...
template Macierz<LZespolona, 5> operator *(LZespolona l, const Macierz<LZespolona, 5> M);
